...
def generate_mask(img_base, img_name):
    ...
    if crater_prediction_count > 0:
        ...
        tmp_tif = individual_folder + file_name + ".tif"
        ...
        tmp_shp = individual_folder + file_name + ".shp"
...
for image_file in image_files:
    if ".png" in image_file[-4:] and not os.path.exists(folder_name + "/split_tifs/shape_files/" + image_file.split(".")[0] + ".shp"):
