...
# File name should be NAC_ROI_ALPHNSUSLOA_E129S3581/NAC_ROI_ALPHNSUSLOA_E129S3581.TIF
folder_name = "NAC_ROI_ALPHNSUSLOA_E129S3581"

if not os.path.exists(folder_name + "/split_tifs/"):
    os.makedirs(folder_name + "/split_tifs/")

run('{}/{}.TIF'.format(folder_name, folder_name), 
	'{}/split_tifs/'.format(folder_name), prefix="", count_limit=-1, img_format="GTiff", extension=".tif")